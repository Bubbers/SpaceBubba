...
install:
	sudo apt-get install g++ software-properties-common freeglut3-dev libfreeimage3 libsfml-dev libfreeimage-dev libassimp-dev libglw1-mesa-dev libglew-dev libxmu-dev libxi-dev libsfml-dev; sudo add-apt-repository ppa:george-edison55/cmake-3.x; sudo apt-get update; sudo apt-get install cmake;
